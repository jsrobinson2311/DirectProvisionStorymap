...
function initMap() {
  ...
  //This loads map layer to just show points, not to be storymapped
  $.getJSON('centres_oct2018.geojson', function(data) {
    var geojson = L.geoJson(data, {
      onEachFeature: function (feature, layer) {
              // does this feature have a property named popupContent?
              layer.bindPopup(
                feature.properties.Chapter + "<br>" +
    ...
    var geojson = L.geoJson(data, {
      onEachFeature: function (feature, layer) {
        (function(layer, properties) {
          ...
          numericMarker.options.shadowSize = [0,0];
